---
name: project-build-and-run
description: Build and/or run this solution, reporting compile errors grouped by project/file. Use when asked to build, compile, run, or launch the project, or to verify a change compiles.
---
...
> skill and the mirrored `.opencode/command/` file in sync with that section.
